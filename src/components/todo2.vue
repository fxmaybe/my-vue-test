...
export default {
    ...
    methods: {
        ...
        fetch() {
            Axios.get( "/mock/todos.txt").then(function(res){
                success && success(res);
              }).catch(function(res){
                error && error(res);
              });
        ...
        save(todos, visibility) {
          ...
          var todosData = new URLSearchParams();
          todosData.append("todos", JSON.stringify({"visibility": visibility, "todos": todos}));

          Axios.post( "/mock/modify.php", todosData).then(function(res){
            success && success(res);
          }).catch(function(res){
            error && error(res);
          });
